...
CRITERIA = [
    ...
    "options": [
        "Sustained, heavy downtrend; no signs of bottoming.",
        "Steep downtrend, no real base or reversal.",
        "Downtrend slows; price starts to form a base.",
        "Base formation becomes clear; sideways action.",
        "Bottom confirmed; first higher low appears.",
